 ...
 * 文章实体
 * @author Songli Li
 * @date 2016年11月19日 下午2:51:20
 */
public class BGArticle implements Serializable{
    ...
    private String syncWithblodgodClient;
    ...
    public String getSyncWithblodgodClient() {
        return syncWithblodgodClient;
    }

    public void setSyncWithblodgodClient(String syncWithblodgodClient) {
        this.syncWithblodgodClient = syncWithblodgodClient;
    }
